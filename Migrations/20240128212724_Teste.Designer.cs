...
namespace HotelWEBAPI.Migrations
{
    ...
    [Migration("20240128212724_Teste")]
    partial class Teste
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelWEBAPI.Cliente", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.Filial", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.FilialQuarto", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.Funcionario", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.Prato", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.PratoConta", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.Produto", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.ProdutoConta", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.Quarto", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.ReservaConta", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.Servico", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.ServicoConta", b =>
                {
            ...
            modelBuilder.Entity("HotelWEBAPI.FilialQuarto", b =>
                {
                    b.HasOne("HotelWEBAPI.Filial", "Filial")
                        .WithMany()
                        .HasForeignKey("FkFilialCodFilial")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelWEBAPI.Quarto", "Quarto")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelWEBAPI.PratoConta", b =>
                {
                    b.HasOne("HotelWEBAPI.Prato", "Prato")
                        .WithMany()
                        .HasForeignKey("FkPratoCodPrato")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelWEBAPI.ReservaConta", "ReservaConta")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelWEBAPI.ProdutoConta", b =>
                {
                    b.HasOne("HotelWEBAPI.Produto", "Produto")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelWEBAPI.ReservaConta", b =>
                {
                    b.HasOne("HotelWEBAPI.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("FkClienteCodCliente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelWEBAPI.Funcionario", "Funcionario")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelWEBAPI.ServicoConta", b =>
                {
                    ...
                    b.HasOne("HotelWEBAPI.Servico", "Servico")
                        .WithMany()
